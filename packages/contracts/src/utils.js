 ...
 */
export function generateGigId(venueName, title, dateStart, city) {
 ...
 */
export function generateGigHash(gig) {
 ...
 */
export function safeValidateGig(data) {
